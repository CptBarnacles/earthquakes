...
class EarthquakesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create earthquake" do
    assert_difference('Earthquake.count') do
      post earthquakes_url, params: { earthquake: { latitude: @earthquake.latitude, locationSource: @earthquake.locationSource, longitude: @earthquake.longitude, quakeID: @earthquake.quakeID } }
    end
  ...
  test "should update earthquake" do
    patch earthquake_url(@earthquake), params: { earthquake: { latitude: @earthquake.latitude, locationSource: @earthquake.locationSource, longitude: @earthquake.longitude, quakeID: @earthquake.quakeID } }
